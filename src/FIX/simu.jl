...
Q0 = Diagonal([(50.0/(3389.5*1e3))^2;(50.0/(3389.5*1e3))^2;(0.1/(3389.5*1e3))^2; 0.005^2; 0.005^2; 0.005^2; (1e-3/(1e3*7.00))^2; (1e-3/(1e3*7.00))^2; (1e-4/(1e3*7.00))^2; (1e-4)^2; (1e-4)^2;(1e-4)^2]) #here we assume the change in a(vector part of the change in quaternion)
